...
2. Add a dated `CHANGELOG.md` section and update version-specific download and license documentation.
...
5. Audit `git diff`, `git status`, tracked binaries, license identifiers, and ignored local asset
   directories.
